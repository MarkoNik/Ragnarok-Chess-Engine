...
//            }
//            if (!Piece.isWhitePiece(board.state[position - 9]) && board.state[position - 9] != Piece.None && board.state[position - 9] != Piece.MaxPiece) {
//                moves.add(new Move(position, position - 9));
//            }
//            if (!Piece.isWhitePiece(board.state[position - 11]) && board.state[position - 11] != Piece.None && board.state[position - 11] != Piece.MaxPiece) {
